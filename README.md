...
🔍 **Finance major who builds software.** I pair financial strategy with code to turn real business problems into working, user-facing products.
...
### 💰 [Fin-Xpert](https://github.com/Ayinde225/Fin-Xpert-AKANJI)
...
An end-to-end platform where my finance background meets real engineering — built from the data layer up to a user-facing product.

- 🧾 **Invoicing** — generate, issue, and track invoices from a payment counter
- 📊 **Double-entry ledger & reports** — Balance Sheet, dashboards, institution-level aggregations
- 🔐 **Security** — multi-factor authentication (TOTP) for staff accounts
- 🌍 **Internationalization** — full i18n with right-to-left (RTL) support
- ⚡ **Performance** — short-TTL caching over heavy aggregation queries
...
*More projects on [github.com/Ayinde225](https://github.com/Ayinde225?tab=repositories)*
...
**Finance**
![Financial Modeling](https://img.shields.io/badge/-Financial_Modeling-1E3A5F?style=flat-square)
![Financial Analysis](https://img.shields.io/badge/-Financial_Analysis-1E3A5F?style=flat-square)
...
<img src="https://github-readme-stats.vercel.app/api?username=Ayinde225&show_icons=true&theme=radical&hide_border=true&count_private=true" alt="GitHub Stats" height="165" />
<img src="https://streak-stats.demolab.com/?user=Ayinde225&theme=radical&hide_border=true" alt="GitHub Streak" height="165" />
...
- **Bachelor of Science in Finance** (Minor: CISA), University of Central Arkansas, *Conway, AR · expected 2026*
  GPA **3.88 / 4.0** · Dean's List (Spring 2025)
- **Bachelor of Business Administration**, International University of Grand-Bassam, *Grand-Bassam · 2024*
